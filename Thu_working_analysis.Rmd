...
```{r loop rf_test year1, echo=TRUE, fig.height=8, cache=TRUE}
# varimp_y1 <- list()
# rf_models <- list()
# rf_plots <- list()
...
```{r loop rf_test y2, echo=TRUE, fig.height=8, cache=TRUE}
...
```{r comparison year2, echo=TRUE, fig.height=8, cache=TRUE}

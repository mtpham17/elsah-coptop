...
## question to ask -- there are currently some columns with "_NA" at the end (I would assume this comes from the dummycols function) -- is this something that holds significance, or should we remove it in data cleaning?
...
#4. Drop all variances and instead focus on means --  not sure what this means
